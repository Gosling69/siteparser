...
# @ErrorHandler
def parse_selenium(item:dict, site: Site) -> ParseData:
    quantity, price = -1, -1
    ...
    driver.close()
    return ParseData(quantity=quantity, price=price)


# @ErrorHandler
def parse_regular(item:dict, site: Site) -> ParseData:
    quantity, price = -1, -1
...
# @ErrorHandler
def parse_ours(item:OurItem, our_site: Site):
